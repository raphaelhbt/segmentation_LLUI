...
class LabelSampler_Pad4LabelPatches(WeightedSampler_Pad4LabelPatches):
    ...
    def get_probabilities_from_label_map(
        ...
        # ini_i, ini_j, ini_k = patch_size // 2        # ADAPTED JOSUA
        ...
        # JOSUA: No cropping, use the entire label map

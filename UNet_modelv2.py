...
class DownBlock(nn.Module):
    def __init__(self, in_channels, out_channels, stride=2): # Because for the first block we don't want to downsample
...
class UpBlock(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv = ConvBlock(out_channels * 2 , out_channels, stride=1)
        self.conv2 = ConvBlock(out_channels, out_channels, stride=1)
...
class UNet3D(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.enc1 = DownBlock(in_channels, 32, stride=1)
        self.enc2 = DownBlock(32, 64)
        self.enc3 = DownBlock(64, 128)
        self.enc4 = DownBlock(128, 256)
        self.enc5 = DownBlock(256, 320)
        
        self.bottleneck_conv_part1 = ConvBlock(320, 320, stride=2)
        self.bottleneck_conv_part2 = ConvBlock(320, 320, stride=1)

...
for epoch in range(NUM_EPOCHS):
    ...
    writer.add_scalars('Metrics/corrected', {'Train_BCE': avg_epoch_BCE}, epoch + 1)
    writer.add_scalars('Metrics/corrected', {'Train_Dice': avg_epoch_dice}, epoch + 1)
    writer.add_scalars('Metrics/corrected', {'Train_Loss': avg_epoch_loss}, epoch + 1)
    ...
    writer.add_scalars('Metrics/corrected', {'Validation_Dice': avg_dice_score}, epoch + 1)
    writer.add_scalars('Metrics/corrected', {'Validation_BCE': avg_val_BCE}, epoch + 1)
    writer.add_scalars('Metrics/corrected', {'Validation_Loss': avg_val_loss}, epoch + 1)
